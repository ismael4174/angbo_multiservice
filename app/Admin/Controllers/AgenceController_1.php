...
class AgenceController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        // });
        $grid->column('services', __('Services'))->display(function () {
            return $this->services->pluck('nom')->implode(', ');
        });
    ...
    protected function form()
    {
        ...
        $form->multipleSelect('service_agences_id', __('Service agences'))->options(ServiceAgence::all()->pluck('nom', 'id'));
