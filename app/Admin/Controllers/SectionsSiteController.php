...
class SectionsSiteController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new SectionsSite());

        $grid->column('id', __('Id'));
        $grid->column('cle', __('Cle'));
    ...
    {
        $show = new Show(SectionsSite::findOrFail($id));

        $show->field('id', __('Id'));
        $show->field('cle', __('Cle'));
    ...
    {
        $form = new Form(new SectionsSite());

        $form->text('cle', __('Cle'));
