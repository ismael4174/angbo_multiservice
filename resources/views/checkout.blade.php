        ...
        <div class="row">
            <div class="col-12">
                <form action="#" class="woocommerce-form-login">
                    ...
                    <div class="form-group">
                        <button type="submit" class="as-btn style4">Login</button>
                ...
                <tbody>
                    <tr class="cart_item">
                        <td data-title="Product">
                            <a class="cart-productimage" href="shop-details"><img width="91" height="91" src="assets/img/cart/cart_1_1.jpg" alt="Image"></a>
                        </td>
                        <td data-title="Name">
                            <a class="cart-productname" href="shop-details">Cereal of Technology</a>
                        </td>
                        <td data-title="Price">
            ...
            <div class="woocommerce-checkout-payment">
                <ul class="wc_payment_methods payment_methods methods">
                    ...
                    <li class="wc_payment_method payment_method_cod">
                        ...
                        <label for="payment_method_cod">Credit Cart <img src="assets/img/cart/all.jpg" alt="image"></label>
                    ...
                    <li class="wc_payment_method payment_method_paypal">
                        ...
                        <label for="payment_method_paypal">Paypal<img src="assets/img/cart/paypal.jpg" alt="PayPal acceptance mark"></label>
                ...
                <div class="form-row place-order">
                    <button type="submit" class="as-btn style4">Place order</button>
                </div>
            </div>
        </div>
    </div>
