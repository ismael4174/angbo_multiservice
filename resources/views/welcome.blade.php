                ...
                @foreach ($parametresGlobaux as $parametresGlobau)
                    <div class="col-lg-6">
                        <div class="about-thumb-wrap3 mb-lg-0 mb-5">
                            ...
                            <div class="thumb-2"><img src="{{ asset('uploads/' . $parametresGlobau->image1) }}"style="width: 377px; height: 404px;" alt="img"></div>
                            <div class="thumb-1"><img src="{{ asset('uploads/' . $parametresGlobau->image2) }}" style="width: 414px; height: 428px;" alt="img"></div>
