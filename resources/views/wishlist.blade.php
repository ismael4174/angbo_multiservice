    ...
    <div class="container">
        <div class="tinv-wishlist woocommerce tinv-wishlist-clear">
                    ...
                    <tbody>
                        <tr class="wishlist_item">
                            ...
                            <td class="product-thumbnail">
                                <a href="shop-details"><img src="assets/img/cart/cart_1_1.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                            </td>
                            <td class="product-name">
                                <a href="shop-details">Jacket Hoodie</a>
                            </td>
                            ...
                            <td class="product-action">
                                <button class="button as-btn style4" name="tinvwl-add-to-cart" value="58" title="Add to Cart">
                        ...
                        <tr class="wishlist_item">
                            ...
                            <td class="product-thumbnail">
                                <a href="shop-details"><img src="assets/img/cart/cart_1_2.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                            </td>
                            <td class="product-name">
                                <a href="shop-details">Sports Shoes</a>
                            </td>
                            <td class="product-price">
                            ...
                            <td class="product-action">
                                <button class="button as-btn style4" name="tinvwl-add-to-cart" value="60" title="Add to Cart">
                                    <i class="fal fa-shopping-cart"></i><span class="tinvwl-txt">Add to Cart</span>
                                </button>
                            </td>
                        </tr>
                        <tr class="wishlist_item">
                            ...
                            <td class="product-thumbnail">
                                <a href="shop-details"><img src="assets/img/cart/cart_1_3.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                            </td>
                            <td class="product-name">
                                <a href="shop-details">Smart Watch</a>
                            </td>
                            <td class="product-price">
                                <ins><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>18.00</bdi></span></ins>
                                <del><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>20.00</bdi></span></del>
            ...
            <div class="social-buttons">
                <span>Share on</span>
                <ul>
                    <li><a href="https://www.facebook.com/sharer/sharer.php?u=permalink" class="social social-facebook" title="Facebook"><i class="fa-brands fa-facebook-f"></i></a></li>
                    <li><a href="https://twitter.com/share?url=permalink" class="social social-twitter " title="Twitter"><i class="fa-brands fa-twitter"></i></a></li>
                    <li><a href="http://pinterest.com/pin/create/button/?url=permalink" class="social social-pinterest " title="Pinterest"><i class="fa-brands fa-pinterest-p"></i></a></li>
                    <li><a href="https://api.whatsapp.com/send?text=permalink" class="social social-whatsapp " title="WhatsApp"><i class="fa-brands fa-whatsapp"></i></a></li>
